    ...
    for provider_info in providers:
        ...
        try:
            ...
            result = {
                ...
                "cost_estimate": provider_info["cost_per_million"] * 0.001,  # Rough estimate
            }
...
def demonstrate_multilingual_embedding():
    ...
    multilingual_frames = [
        FrameRecord(uri="en.txt", content="Hello, how are you?", metadata={"lang": "en"}),
        FrameRecord(uri="es.txt", content="Hola, ¿cómo estás?", metadata={"lang": "es"}),
        FrameRecord(uri="fr.txt", content="Bonjour, comment allez-vous?", metadata={"lang": "fr"}),
        FrameRecord(uri="de.txt", content="Hallo, wie geht es dir?", metadata={"lang": "de"}),
        FrameRecord(uri="zh.txt", content="你好，你好吗？", metadata={"lang": "zh"}),
        FrameRecord(uri="ja.txt", content="こんにちは、元気ですか？", metadata={"lang": "ja"}),
    ]
