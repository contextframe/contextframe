                            ...
                            mappings.append(
                                FileMapping(
                                    ...
                                    custom_metadata={
                                        ...
                                        "data_category": self._categorize_data(
                                            file_path.name
                                        ),
                                    },
                                )
                ...
                if file_path.is_file() and file_path not in seen_paths:
                    mappings.append(
                        FileMapping(
                            ...
                            custom_metadata={
                                "bib_type": "bibtex"
                                if file_path.suffix in [".bib", ".bibtex"]
                                else "other",
                                "priority": "high",
                            },
                        )
    ...
    def define_collections(
        ...
        collection_defs = [
            (
                "papers",
                "Research Papers",
                "Published and draft research papers",
                ["papers", "research"],
            ),
