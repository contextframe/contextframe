...
class ExtractionResult:
    ...
    def to_frame_record_kwargs(self) -> dict[str, Any]:
        ...
        standard_fields = {
            "source_file", "source_type", "source_url", "created_at", 
            "modified_at", "author", "description", "custom_metadata",
            "tags", "context", "parent_id", "related_ids", "reference_ids",
            "member_of", "version", "language", "revision"
        }
