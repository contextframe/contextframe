...
class MCPClient:
    ...
    async def send_message(
        ...
        message = {"jsonrpc": "2.0", "method": method, "id": self._next_id()}
        if params:
...
async def main():
    ...
    try:
        ...
        result = await client.call(
            "initialize", {"protocolVersion": "0.1.0", "capabilities": {}}
        )
        print(
        ...
        result = await client.call(
            "resources/read", {"uri": "contextframe://dataset/info"}
        )
        ...
        result = await client.call(
            "tools/call",
            {
                ...
                "arguments": {"query": "test", "search_type": "text", "limit": 3},
            },
        )
